...
/** 
 * DAO for table "CARTOONS".
*/
public class CartoonsDao extends AbstractDao<Cartoons, Long> {

    public static final String TABLENAME = "CARTOONS";

    /**
     * Properties of entity Cartoons.<br/>
    ...
    public CartoonsDao(DaoConfig config) {
        super(config);
    }
    
    public CartoonsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CARTOONS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CARTOONS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Cartoons entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Cartoons entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(Cartoons entity) {
    ...
    @Override
    public Cartoons readEntity(Cursor cursor, int offset) {
        Cartoons entity = new Cartoons( //
    ...
    @Override
    public void readEntity(Cursor cursor, Cartoons entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Cartoons entity, long rowId) {
        entity.setID(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Cartoons entity) {
        if(entity != null) {
            return entity.getID();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Cartoons entity) {
