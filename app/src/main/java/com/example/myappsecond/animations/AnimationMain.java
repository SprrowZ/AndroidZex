package com.example.myappsecond.animations;
...
public class AnimationMain extends Activity implements View.OnClickListener{
    private Button btn1;
    private Button btn2;
    private Button btn3;
    private Button btn4;
      ...
      Animation alpha= AnimationUtils.loadAnimation(this,R.anim.alpha);
           iv.startAnimation(alpha);
            ...
            case R.id.btn7:
                ...
                break;
            case R.id.btn8:
                Intent intent=new Intent(this,Animation_attribute.class);
                startActivity(intent);
                overridePendingTransition(R.anim.rotate,R.anim.alpha);
                break;
            case R.id.btn9:
                Intent intent1=new Intent(this,Animation_example.class);
                startActivity(intent1);
                overridePendingTransition(R.anim.alpha,R.anim.rotate);
                break;
            case R.id.btn10:
            startActivity(new Intent(this,ValueAnimators.class));
