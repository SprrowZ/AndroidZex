...
import com.example.myappsecond.utils.ExtraUtil.CommonPagerAdapter;
...
public class Memory extends BaseActivity {
    ...
    //头部填一张，尾部填一张，实现无线循环
    int [] ResId={R.drawable.my6,R.drawable.my1,R.drawable.my2,R.drawable.my3,
            R.drawable.my4,R.drawable.my5,
            R.drawable.my6,R.drawable.my1};
