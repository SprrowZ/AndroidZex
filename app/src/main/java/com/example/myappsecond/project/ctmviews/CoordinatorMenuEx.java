 ...
 */
public class CoordinatorMenuEx extends FrameLayout {
    ...
    public CoordinatorMenuEx(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoordinatorMenuEx(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        Log.d(TAG, "drawChild: mShadowOpacity: " + mShadowOpacity);
    ...
    public void openMenu() {
        ...
        ViewCompat.postInvalidateOnAnimation(CoordinatorMenuEx.this);
    }
