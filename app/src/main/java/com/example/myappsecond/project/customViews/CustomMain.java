...
import com.example.myappsecond.project.customViews.ListView_Delete.List_Main;
import com.example.myappsecond.project.customViews.Mypractice.PracticeWave;
...
public class CustomMain extends BaseActivity implements View.OnClickListener {
    private Button btn1;
    private Button btn2;
    private Button btn3;
    private Button btn4;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn1:
                Intent intent1=new Intent(this,Custom_First.class);
                startActivity(intent1);
                break;
            case R.id.btn2:
                Intent intent2=new Intent(this,Custom_Second.class);
                startActivity(intent2);
                break;
            case R.id.btn3:
                Intent intent3=new Intent(this,Custom_Third.class);
                startActivity(intent3);
                break;
            case R.id.btn4:
                Intent intent4=new Intent(this,Custom_Fivth.class);
                startActivity(intent4);
                break;
            case R.id.btn5:
                startActivity(new Intent(this,Custom_Sixth.class));
                break;
            case R.id.btn6:
                startActivity(new Intent(this,List_Main.class));
                break;
            case R.id.btn7:
                startActivity(new Intent(this,Custom_Seventh.class));
                break;
            case R.id.btn8:
...
//                six.setVisibility(View.VISIBLE);
                break;
            case  R.id.btn14:
                startActivity(new Intent(this,CustomMain2.class));
                break;
            default:
                break;
        }
