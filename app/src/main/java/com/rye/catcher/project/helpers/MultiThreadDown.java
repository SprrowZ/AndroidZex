...
//    }
    ...
    public MultiThreadDown(String loadUrl, String filePath) {
        this( loadUrl, filePath, DEFAULT_THREAD_COUNT, null);
    }
    public MultiThreadDown(String loadUrl, String filePath, int threadCount) {
    ...
    private static  class WeakHandler extends Handler{
        private WeakReference<MultiThreadDown> weakReference;
        public WeakHandler(MultiThreadDown multiThreadDown){
            weakReference=new WeakReference<>(multiThreadDown);
        }

        @Override
        public void handleMessage(Message msg) {
            MultiThreadDown threadDown=weakReference.get();
