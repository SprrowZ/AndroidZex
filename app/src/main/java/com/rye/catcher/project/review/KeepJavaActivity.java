...
public class KeepJavaActivity extends BaseActivity {
    private Button btn1;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Notification noti = new NotificationCompat.Builder(KeepJavaActivity.this)//实例化Builder
                               ...
                               //.setProgress(100,50,false)
                                 ...
                                 .setSmallIcon(R.mipmap.ic_launcher)//设置状态栏显示时的图标
                                  ...
                                  .setContentIntent(PendingIntent.getActivity(KeepJavaActivity.this, 0, new Intent(KeepJavaActivity.this,MainActivity.class), 0))//设置点击时的意图
