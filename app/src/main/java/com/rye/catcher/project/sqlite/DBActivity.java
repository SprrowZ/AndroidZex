...
import com.rye.catcher.project.SQLiteZ.Cartoon;
import com.rye.catcher.project.SQLiteZ.CartoonDao;
...
public class DBActivity extends BaseActivity {
    ...
    private DBCartoonManage dbManager;
    ...
    public void initEvent() {
        ...
        //初始化DBManger
        dbManager = new DBCartoonManage(this);
        //第二个测试
    ...
    public void updateCartoons(View view) {
        Cartoon cartoon = new Cartoon();
        // cartoon.setValue(Cartoon.TABLE_PGC_ID,"15");
