...
public class SDHelper {
    ...
    //app私有存储
    public static String external = BaseApplication.getInstance().getExternalFilesDir(null) + File.separator;
    ...
    //app私有缓存
    public static String externalCache = BaseApplication.getInstance().getExternalCacheDir() + File.separator;
