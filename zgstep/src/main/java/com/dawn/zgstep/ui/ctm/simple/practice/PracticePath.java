package com.dawn.zgstep.ui.ctm.simple.practice;
...
public class PracticePath extends View {
    Paint zPaint;
    Paint mPaint;
    Paint paint;
    Context mContext;

    public PracticePath(Context context) {
        super(context);
    }

    public PracticePath(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext=context;
        //给三个画笔分别初始化
        mPaint=new Paint();
